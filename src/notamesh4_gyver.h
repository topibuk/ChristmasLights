...
#define POWER_I       500        // Ток блока питания в милиАмперах
...
#define MY_MODE     1,2,19,21,32,34,37,38,39,40
...
#define DEMO_TIME     255           // Время отображение эффекта в демо режиме в секундах

#define CHANGE_ON     1           // Включить плавную смену эффектов
#define CHANGE_SPARK  3           // Эффект смены 0 - без эффекта, 1 - искры (бенгальский огонь) 2 - яркий свет
